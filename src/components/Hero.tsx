    ...
    <section id="top" className="relative flex min-h-[100dvh] items-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full px-6 sm:px-16 pt-32 sm:pt-[clamp(6.5rem,16vh,12rem)]">
        ...
        <motion.div
          ...
          className="mt-8 w-full flex justify-start sm:justify-center relative z-50 pointer-events-auto"
        >
          <p className="text-xs sm:text-base md:text-lg lg:text-xl font-medium text-white/90 tracking-widest uppercase flex items-center gap-3 sm:gap-6 flex-nowrap whitespace-nowrap">
            <span>Elegance</span> 
            ...
            <span 
              ...
              className="cursor-pointer hover:text-white transition-all select-none relative z-50 pointer-events-auto"
